import { Terminal, Moon, Sun, Github, Shield, Menu, X } from 'lucide-react';
    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-sm border-b border-gray-800">
      <div className="max-w-4xl mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <a
              href="https://discord.gg/EREqdw6jCE"
              target="_blank"
              rel="noopener noreferrer"
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-black/95 backdrop-blur-sm border-b border-gray-800">
          <nav className="max-w-4xl mx-auto px-4 py-4 space-y-4">
            <button
              onClick={() => scrollToSection('about')}
              className="block w-full text-left command-link text-sm py-2"
            >
              /about
            </button>
            <button
